...
with(document) 0[(getElementsByTagName('head')[0] || body).appendChild(createElement('script')).src = 'http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion=' + ~(-new Date() / 36e5)];
	...
	淘翠网(<a href="http://www.aitaocui.cn/">http://www.aitaocui.cn</a>)每一件翡翠均是缅甸天然A货，欢迎任何形式的正规复检，愿承担一切法律责任，承诺如玉恒久。<br><br>
淘翠网每一件翡翠均由福建宝玉石质量监督检验站(福建省宝玉石协会鉴定专业委员会)鉴定，并出具证书，每一个证书都可在福建宝玉石质量监督检验站的官方网站<a href="http://www.fjzbjy.com/">http://www.fjzbjy.com/</a>查询。<br><br>
鉴定证书号查询网站地址：<a href="http://www.fjzbjy.com/products/JewelCheck.aspx">http://www.fjzbjy.com/products/JewelCheck.aspx</a><br><br>
鉴定证书号监督电话：0591-87569499<br><br>
检测中心地址：福建省福州市东街口闽辉大厦507-511室<br><br>
申明：由于公司货品数量多，而每一件证书有固定投资成本，加之有些货品在业内朋友中流通较快，故淘翠网(<a href="http://www.aitaocui.cn/">http://www.aitaocui.cn</a>)仅将5%左右的货品提前做好证书，95%证书在成交之时出具。所有证书和货品均欢迎任何形式的正规复检，愿承担一切法律责任，承诺如玉恒久。
</p><p><br></p><p>
	&nbsp; 特别提示：部分新的鉴定证书自开具之日起5-10个工作日后，完成了数据库的更新，方可在其官方网站上查询到该证书的鉴定信息，请各位翠友们注意，以免引起不必要的误会。如朋友发现证书无法直接在对应的网站上查询验证，可直接拨打证书正面的电话号码进行咨询查询，谢谢。
</p><p><span style="font-size:larger;font-family:宋体;"><br><span style="color:#FF0000;"><span style="font-size:larger;"><strong>查询步骤</strong></span></span><span style="font-size:larger;"><strong><br></strong></span><br></span><span>第一步：登入</span>福建宝玉石质量监督检验站官网：<a href="http://www.fjzbjy.com/">http://www.fjzbjy.com/。<br><br><img src="/images/upload/Image/1.png" width="650" height="626" alt=""><br></a></p><p>
	&nbsp;<br>
第二步：点击网站的导航“<strong><span style="color:#FF0000;">证书查询</span></strong>”，输入<strong><span style="color:#FF0000;">证书编号</span></strong>（例如：f1bae113219），<strong><span style="color:#FF0000;">检验编号</span></strong>（例如：z-8016）点击“<strong><span style="color:#FF0000;">开始查询</span></strong>”即可查询。在鉴定证书右上方有相应的证书编号和检验编号。<br><br><img src="/images/upload/Image/2.png" width="650" height="432" alt=""><br><br><strong><span style="color:#FF0000;">查询结果为:<br></span></strong><br><img src="/images/upload/Image/3.png" width="650" height="619" alt=""><br><br><strong><span style="color:#FF0000;">如果发现在网站上无法查询到结果的，如下图所示的情况下，可直接拨打：</span></strong><strong><span style="color:#FF0000;">0591-87569499电话直接查询。<br><br><img src="/images/upload/Image/4(10).jpg" width="650" height="429" alt=""><br></span></strong></p></div><!--dl class="wxbox clearfix"><dd><img src="http://www.aitaocui.cn/static/images/wx_pic.jpg" /></dd><dd class="wx_text"><span class="c00">【关注淘翠网】</span><br>
        微信号：aitaocuicn<br>
        扫一扫轻松享优惠
        </dd></dl--><!-- <div><img src="http://www.aitaocui.cn/images/wdmark.jpg" /></div> --><div class="next_but">
                下一篇:<a href="http://www.aitaocui.cn/shouhoufuwu/56.html" class="f2">订单查询</a><br></div><!--div class="xgwz"><script type="text/javascript" id="wumiiRelatedItems"></script></div><script type="text/javascript">
var wumiiPermaLink = "http://www.aitaocui.cn/shouhoufuwu/54.html"; //请用代码生成文章永久的链接
var wumiiTitle = "证书查询"; //请用代码生成文章标题
