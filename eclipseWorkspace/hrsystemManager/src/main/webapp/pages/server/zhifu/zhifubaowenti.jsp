...
with(document) 0[(getElementsByTagName('head')[0] || body).appendChild(createElement('script')).src = 'http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion=' + ~(-new Date() / 36e5)];
                    ...
                    </style><p><strong>1、支付宝和卡都是在网上使用，它们之间的区别？<br></strong></p><div><br>
  网上银行不能直接支付，支付宝是一个中介的角色，保护买家的同时也保护卖家。就是说，拍下了东西以后，买家先把钱从网银转到支付宝，卖家看到买家付款，再发货。</div><div><br><strong>2、银行扣款已经成功，为什么支付宝账户没有钱？</strong></div><div><br>
  请别担心！银行扣款已经成功，支付宝账户没有钱，这是因为银行的数据没有即时传输给我们，我们会在第二个工作日与银行对账后，给予确认，请再耐心等待一下。</div><div><br><strong>3、是否可以通过银行柜台汇款给支付宝账户？<br><br type="_moz"></strong></div><div>  不可以，通过银行给支付宝账户充值只能通过在线网银的方式，您如果暂时没有网银，也可以选择邮政网汇e来为您支付宝账户充值，您可以到中国邮政局办理邮政网汇e业务并设定取款密码，您就可以登录支付宝账户对支付宝账户完成充值。网上银行的开通方法，具体内容可登录银行网站进行相关了解。</div><div><br><strong>4、银行账户重复扣款</strong><b>或者自己重复多次付款怎么办？</b></div><div><br>
  由于您的支付信息银行没有即时传输给我们，造成您的银行重复扣款，我们感到非常抱歉。不过请放心，我们会在第二个工作日和银行对帐，确认您的汇款后，重复支付款项会直接充值到您的支付宝账户。对于工行和招行请您支付后的第三个工作日查看您的银行是否收到了这笔退款。对于建行异地重复汇款目前还无法做到自动退款，我们需要提交建设银行手工处理，所以您需要5个工作日后查看您的银行是否收到了这笔退款。</div><div></div><div><strong>5、在线支付/充值要在消费者银行卡上扣除手续费吗？</strong></div><div><br>
  这是不需要的。使用我们的在线支付系统是不收取任何费用的。</div><div><br><strong>6、如何查询账户明细？</strong></div><div><br>
  您可以登录支付宝账户-我的支付宝-账户明细查询-选择您要查询的时间后确认，页面上会显示出来。</div><div><br><strong>7、我可以用关闭窗口的方式退出网上银行网页吗?</strong></div><div><br>
  不要用关闭浏览器窗口的方式退出，为确保网上银行的连接被安全地终止，在完成所有交易后，使用系统中的“退出”功能退出网上理财服务。</div><div><br><strong>8、为什么我已经提交退款但还是没有收到？</strong></div><div><br>
  提现失败，需要充值退回的款项是原路返回的，从哪张卡上支出就会退回到哪张卡上，不能退到其他的银行卡上。需要注意有些银行支付时您是使用虚拟的电子支付卡支付的，充值退回也会退回到您的电子支付卡中（如招行支付卡、工行E通卡、农行电子支付卡）。</div><div><br><strong>9、打开支付页面，提示“该页无法显示”或空白页，可能是什么原因？</strong></div><div><br>
  A、没有升级IE浏览器，导致加密级别过低，无法进入银行系统。请升级到6.0及以上版本。</div><div><br>
  B、上网环境或上网方式受限，可能是网络服务商限制，如有条件更换一种上网方式或环境。　　</div><div><br>
  C、瞬间网络不通，尝试刷新页面；如果刷新不能解决问题，可能由于浏览器设置缓存，请在IE菜单--工具--Internet选项-- 点击“删除cookies”和“删除文件”，用以清除临时文件。</div></div><!--dl class="wxbox clearfix"><dd><img src="http://www.aitaocui.cn/static/images/wx_pic.jpg" /></dd><dd class="wx_text"><span class="c00">【关注淘翠网】</span><br>
        微信号：aitaocuicn<br>
        扫一扫轻松享优惠
                ...
                上一篇:<a href="http://www.aitaocui.cn/pay/69.html" class="f2">银行汇款/转账</a></div><!--div class="xgwz"><script type="text/javascript" id="wumiiRelatedItems"></script></div><script type="text/javascript">
var wumiiPermaLink = "http://www.aitaocui.cn/pay/78.html"; //请用代码生成文章永久的链接
var wumiiTitle = "支付宝常见问题"; //请用代码生成文章标题
