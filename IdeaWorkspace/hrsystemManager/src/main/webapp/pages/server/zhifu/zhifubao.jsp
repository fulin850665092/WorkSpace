...
with(document) 0[(getElementsByTagName('head')[0] || body).appendChild(createElement('script')).src = 'http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion=' + ~(-new Date() / 36e5)];
	...
	淘翠网（<a href="http://www.aitaocui.cn/">www.aitaocui.cn</a>)是支付宝(<a href="http://www.alipay.com">www.alipay.com</a>) 特级合作伙伴，每年有大量数额的支付流水，支持担保交易和及时到账。<br><br>
淘翠网（<a href="http://www.aitaocui.cn/">www.aitaocui.cn</a>）自创办以来便坚持诚信为本，顾客至上”的经营宗旨，以物有所值，物超所值的品质方针为广大客户提供品种更多，质量更高，服务更好的翡翠珍品。我们在交易上自始至终恪守商业道德，在汇款交易金额上未有过一分一厘的差错，我们的一切努力都在实践诚信为本，顾客至上的核心宗旨！<br><strong><br>
汇款前请注意：<br></strong><br>
&nbsp; &nbsp; 1、先联系在线客服，确认您要订购的翡翠及金额；<br><br>
&nbsp; &nbsp; 2、汇款成功后，银行会即时通知我们的财务人员，我们将在第一时间内向您确认；<br><br>
&nbsp; &nbsp; 3、淘翠网是支付宝签约客户，支持担保交易和即时到账；<br><br>
&nbsp; &nbsp; 4、如果支付过程中有疑问，请致电 400-1010-871；<br><br>
&nbsp;<br><img src="/images/upload/image/20181013/20181013102612_79853.jpg" alt=""></p></div><!--dl class="wxbox clearfix"><dd><img src="http://www.aitaocui.cn/static/images/wx_pic.jpg" /></dd><dd class="wx_text"><span class="c00">【关注淘翠网】</span><br>
        微信号：aitaocuicn<br>
        扫一扫轻松享优惠
        </dd></dl--><!-- <div><img src="http://www.aitaocui.cn/images/wdmark.jpg" /></div> --><div class="next_but">
                下一篇:<a href="http://www.aitaocui.cn/pay/79.html" class="f2">网上支付常见问题</a><br></div><!--div class="xgwz"><script type="text/javascript" id="wumiiRelatedItems"></script></div><script type="text/javascript">
var wumiiPermaLink = "http://www.aitaocui.cn/pay/57.html"; //请用代码生成文章永久的链接
var wumiiTitle = "支付宝"; //请用代码生成文章标题
