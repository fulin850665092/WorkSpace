...
with(document) 0[(getElementsByTagName('head')[0] || body).appendChild(createElement('script')).src = 'http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion=' + ~(-new Date() / 36e5)];
                    ...
                    </style><p><br><strong>一、订单<br><br></strong>1．请您在淘翠网承诺的退换货期限内验收您收到的包裹；<br><br>
2．请您在收到包裹后查看包裹外部包装是否完好，包裹内商品是否丢失或有毁损影响您的使用，如果出现上述情况导致您申请退换货，请您要求邮局或者物流公司出具包裹破损证明；<br><br>
3．验收包裹时请您小心拆开，以免尖锐物品破坏包裹内商品；<br><br>
4．请您在签收时仔细核对：产品及配件、淘翠网的发货清单、产品数量、翡翠质检证书等是否齐全。<br><strong><br>
二、为了让您在淘翠网拥有愉快、安全的网上购物体验，淘翠网为您提供最安全且免费的配送服务<br></strong><br>
1．货品包装<br><br>
淘翠网与邮政EMS及顺丰速运联手，专门针对翡翠邮寄提供高强度防震/防压包装，您完全不用担心邮寄过程中出现的损坏问题。<br><br>
2．运输保险<br><br>
对于在淘翠网购买翡翠的客户，不论价值高低均采取保价寄出，确保邮寄过程的安全，为您的宝贝提供一份运输保险。<br><br>
3．配送方式<br><br>
为确保您所订购的宝贝万无一失，淘翠网指定采用EMS及顺丰速运进行配送，为您的宝贝全程保驾护航。<br><br>
4．免费快递<br><br>
淘翠网为您购买的宝贝提供免费保价配送服务，如若退换货则需要<span>您</span>承担商品<span>来回</span>的保价配送费用。
        ...
        扫一扫轻松享优惠
                ...
                下一篇:<a href="http://www.aitaocui.cn/peisongfuwu/62.html" class="f2">签收与拒收</a><br>
                
                上一篇:<a href="http://www.aitaocui.cn/peisongfuwu/60.html" class="f2">送货范围</a></div><!--div class="xgwz"><script type="text/javascript" id="wumiiRelatedItems"></script></div><script type="text/javascript">
var wumiiPermaLink = "http://www.aitaocui.cn/peisongfuwu/61.html"; //请用代码生成文章永久的链接
var wumiiTitle = "配送说明"; //请用代码生成文章标题
